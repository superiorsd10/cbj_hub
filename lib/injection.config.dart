...
import 'domain/rooms/i_saved_rooms_repo.dart' as _i17;
import 'domain/routine/i_routine_cbj_repository.dart' as _i13;
import 'domain/saved_devices/i_saved_devices_repo.dart' as _i15;
import 'domain/scene/i_scene_cbj_repository.dart' as _i19;
...
import 'infrastructure/devices/lifx/lifx_connector_conjector.dart' as _i21;
...
import 'infrastructure/room/saved_rooms_repo.dart' as _i18;
import 'infrastructure/routines/routine_repository.dart' as _i14;
import 'infrastructure/saved_devices/saved_devices_repo.dart' as _i16;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i13.IRoutineCbjRepository>(
      () => _i14.RoutineCbjRepository());
  gh.lazySingleton<_i15.ISavedDevicesRepo>(() => _i16.SavedDevicesRepo());
  gh.lazySingleton<_i17.ISavedRoomsRepo>(() => _i18.SavedRoomsRepo());
  gh.lazySingleton<_i19.ISceneCbjRepository>(() => _i20.SceneCbjRepository());
  gh.singleton<_i21.LifxConnectorConjector>(_i21.LifxConnectorConjector());
  gh.singleton<_i22.PhilipsHueConnectorConjector>(
      _i22.PhilipsHueConnectorConjector());
  gh.singleton<_i23.SwitcherConnectorConjector>(
      _i23.SwitcherConnectorConjector());
  gh.singleton<_i24.TasmotaConnectorConjector>(
      _i24.TasmotaConnectorConjector());
  gh.singleton<_i25.TuyaSmartConnectorConjector>(
      _i25.TuyaSmartConnectorConjector());
  gh.singleton<_i26.XiaomiIoConnectorConjector>(
      _i26.XiaomiIoConnectorConjector());
  gh.singleton<_i27.YeelightConnectorConjector>(
      _i27.YeelightConnectorConjector());
  return get;
}
